package com.tongc.easyui.builder;
...
import com.tongc.easyui.po.TableField;
...
public class ConfigBuilder {
    ...
    private final com.tongc.easyui.DataSourceConfig dataSourceConfig;
    ...
    public ConfigBuilder(PackageConfig packageConfig, com.tongc.easyui.DataSourceConfig dataSourceConfig, StrategyConfig strategyConfig, TemplateConfig template, GlobalConfig globalConfig) {
    ...
    private void handlerDataSource(com.tongc.easyui.DataSourceConfig config) {
