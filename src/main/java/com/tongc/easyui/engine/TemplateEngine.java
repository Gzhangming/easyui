package com.tongc.easyui.engine;//
//                            _ooOoo_
//                           o8888888o
//                           88" . "88
//                           (| -_- |)
...
import com.tongc.easyui.builder.ConfigBuilder;
import com.tongc.easyui.config.TempConfig;
import com.tongc.easyui.po.TableInfo;
import com.tongc.easyui.util.BaseFieldUtil;
import com.tongc.easyui.util.StrKit;
import com.tongc.easyui.util.ToolUtil;
...
public class TemplateEngine {
    ...
    public TemplateEngine(com.tongc.easyui.DataSourceConfig dataSourceConfig, TempConfig config) {
        initBeetlEngine();
        initTableList(dataSourceConfig);
        tempConfig = config;
    }

    protected void initTableList(com.tongc.easyui.DataSourceConfig dataSourceConfig) {
